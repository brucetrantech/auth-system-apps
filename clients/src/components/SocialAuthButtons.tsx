...
export default function SocialAuthButtons({ action }: SocialAuthButtonsProps) {
	...
	const handleAppleAuth = () => {
		window.location.href = `${API_BASE_URL}/auth/oauth/apple`;
	};
	...
	return (
		<div className="social-buttons">
			...
			<button type="button" className="social-btn" onClick={handleFacebookAuth}>
				<svg viewBox="0 0 24 24">
					<path
						fill="#1877F2"
			...
			<button type="button" className="social-btn" onClick={handleAppleAuth}>
				<svg viewBox="0 0 24 24">
					<path
						fill="#000000"
